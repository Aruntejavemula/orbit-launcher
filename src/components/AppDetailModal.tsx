...
export default function AppDetailModal({ app, onClose }: Props) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 grid place-items-center bg-ink/40 px-4 backdrop-blur-sm fade-in"
      onClick={onClose}
    >
      <div
        role="dialog"
        aria-modal="true"
        className="relative w-full max-w-md rounded-3xl p-6 shadow-pop"
